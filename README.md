...
- Regular enemies include blue uniform characters, user-provided red armband guard sprites, and elite Hazmat animation assets that resemble biohazard suits
...
- Three types of regular enemies and a final boss with two phases
